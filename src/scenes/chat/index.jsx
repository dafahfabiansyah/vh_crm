...
const Chat = () => {
  ...
  const handleTicketClick = (user) => {
    setCurrentUser(user);
    setCurrentChat(mockChatData[user] || []);
    setOpenModal(true);
  };
        ...
        <Box sx={{ flexGrow: 1, p: 3, bgcolor: "#f5f7fa" }}>
          ...
          <FeatureCard>
            <FeatureIcon sx={{ bgcolor: "#fff3e0" }}>
              <Box
                component="img"
                src="/images/Yellow envelope with red circle notification 3D illustration.jpg" // Update with the actual path
                alt="Crown"
          ...
          <FeatureCard>
            <FeatureIcon sx={{ bgcolor: "#e8f5e9" }}>
              <Box
                component="img"
                src="/images/Graident Ai Robot.jpg" // Update with the actual path
                alt="AI Robot"
                sx={{ width: 64, height: 64 }}
              />
            </FeatureIcon>
          ...
          <FeatureCard>
            <FeatureIcon sx={{ bgcolor: "#e3f2fd" }}>
              <Box
                component="img"
                src="/images/—Pngtree—customer service female character people_6421157.png" // Update with the actual path
                alt="People"
                sx={{ width: 64, height: 64 }}
              />
            </FeatureIcon>
